...
function play(event) {
    ...
    for (let i = 0; i < 9; i += 3) {
        if (ticks.boxes[i] != null && ticks.boxes[i + 1] != null && ticks.boxes[i + 2] != null) {
            if ((ticks.boxes[i] == ticks.boxes[i + 1]) && (ticks.boxes[i + 1] == ticks.boxes[i + 2])) {
                win = ticks.boxes[i];
            }
        }
        if (win !== null) {
    ...
    if (win === null) {
        for (let i = 0; i < 3; i++) {
            if (ticks.boxes[i] != null && ticks.boxes[i + 3] != null && ticks.boxes[i + 6] != null) {
                if ((ticks.boxes[i] == ticks.boxes[i + 3]) && (ticks.boxes[i + 3] == ticks.boxes[i + 6])) {
                    win = ticks.boxes[i];
                }
                if (win !== null) {
                    break;
    ...
    if (win === null) {
        if (ticks.boxes[0] != null && ticks.boxes[4] != null && ticks.boxes[8] != null) {
            if ((ticks.boxes[0] == ticks.boxes[4]) && (ticks.boxes[4] == ticks.boxes[8])) {
                win = ticks.boxes[4];
            }
        }

        if (ticks.boxes[2] != null && ticks.boxes[4] != null && ticks.boxes[6] != null) {
            if ((ticks.boxes[2] == ticks.boxes[4]) && (ticks.boxes[4] == ticks.boxes[6])) {
                win = ticks.boxes[4];
            }
        }
    }
